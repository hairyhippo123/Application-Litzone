...
public class HoaDonRepo {
    ...
    public ArrayList<HoaDon> getAllHoaDon() {
        ...
        String sql = """
                SELECT 
                    ...
                    HD.TrangThai -- Thêm trạng thái để phân biệt hóa đơn đã thanh toán hay chưa
                FROM HoaDon HD 
        ...
        try (Connection conn = DBConnection.getConnection(); PreparedStatement ps = conn.prepareStatement(sql)) {
            ...
            while (rs.next()) {
                ...
                hd.setTrangThai(rs.getBoolean("TrangThai")); // Gán trạng thái
                list.add(hd);
            }
    ...
    public boolean updateMaPhieuGiamGia(String maHoaDon, String tenPhieuGiamGia) {
        String sql = "UPDATE HoaDon SET IDPhieuGiamGia = (SELECT TOP 1 ID FROM PhieuGiamGia WHERE TenPhieuGiamGia = ?) WHERE MaHoaDon = ?";
        try (Connection conn = DBConnection.getConnection(); PreparedStatement ps = conn.prepareStatement(sql)) {
