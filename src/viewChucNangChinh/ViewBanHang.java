...
// Phương thức cập nhật combobox phiếu giảm giá
    ...
    public void onPhieuGiamGiaUpdated() {
        updatePhieuGiamGiaComboBox(); // Cập nhật combobox phiếu giảm giá
        System.out.println("Cập nhật combobox phiếu giảm giá trong ViewBanHang.");
    }
...
// Thêm phương thức xử lý sự kiện thay đổi mã nhân viên
    ...
    private void initComponents() {
        ...
        panelTaoHoaDonLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {cbxNVBH, cbxPhieuGiamGia, txtCanTra, txtMaHD, txtSDTHD, txtTenKHHD, txtTienKhachDua, txtTienThua, txtTong});
        ...
        panelTaoHoaDonLayout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {cbxNVBH, cbxPhieuGiamGia, txtCanTra, txtMaHD, txtSDTHD, txtTenKHHD, txtTienKhachDua, txtTienThua, txtTong});
        ...
        panelHD.add(rdoChuaTT, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 20, -1, -1));
        ...
        panelHD.add(rdoDaTT, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 20, -1, -1));
...
//    }
    public boolean ValidateHD() {
        ...
        if (maNhanVien == null || maNhanVien.trim().isEmpty()) {
            stb.append("Vui lòng chọn nhân viên bán hàng!\n");
        }
        if (stb.length() > 0) {
            JOptionPane.showMessageDialog(this, stb);
            return false;
