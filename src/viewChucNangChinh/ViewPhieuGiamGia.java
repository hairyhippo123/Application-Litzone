...
public class ViewPhieuGiamGia extends javax.swing.JPanel {
        ...
        try {
            ...
            if (repository.add(pgg)) {
                ...
                if (updateListener != null) {
                    updateListener.onPhieuGiamGiaUpdated(); // Gọi thông báo cập nhật
                }
            } else {
    ...
    private void btnSuaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSuaMouseClicked
        ...
        try {
            ...
            boolean trangThai = rdoChuaHetHan.isSelected(); // true nếu chọn "Chưa hết hạn", false nếu "Đã hết hạn"
    ...
    private void btnXuatPhieuGiamGiaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXuatPhieuGiamGiaActionPerformed
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            try {
                ...
                // Sử dụng font NotoSans-Regular.ttf hỗ trợ tiếng Việt
                String fontPath = "/icon/fonts/NotoSans-Regular.ttf"; // Đường dẫn trong dự án
                try {
                    ...
                    e.printStackTrace();
                    JOptionPane.showMessageDialog(this, "Lỗi nạp font: " + e.getMessage());
                }
