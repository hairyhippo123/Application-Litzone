...
public class ViewHoaDon extends javax.swing.JPanel implements HoaDonUpdateListener {
    ...
    public void loadHoaDonList() {
        ...
        model.setRowCount(0);
        ArrayList<HoaDon> hoaDons = hoaDonRepo.getAllHoaDon(); // Lấy tất cả hóa đơn
        for (HoaDon hoaDon : hoaDons) {
            if (hoaDon.getTrangThai()) {
                String maPhieuGiamGia = hoaDon.getMaPhieuGiamGia() != null ? hoaDon.getMaPhieuGiamGia() : "Không có"; // Xử lý trường hợp null
                model.addRow(new Object[]{
                    hoaDon.getMaHoaDon(),
                    hoaDon.getMaKhachHang(),
                    hoaDon.getMaNhanVien(),
                    maPhieuGiamGia, // Chỉ hiển thị mã phiếu giảm giá
                    hoaDon.getNgayTao(),
                    hoaDon.getTongTien(),
...
// Duyệt qua danh sách hóa đơn
    ...
    private void lamMoiForm() {
        ...
        // Làm mới bảng ChiTietHoaDon (xóa toàn bộ dữ liệu)
        DefaultTableModel chiTietModel = (DefaultTableModel) ChiTietHoaDon.getModel();
